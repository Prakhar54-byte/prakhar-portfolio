...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const email = import.meta.env.VITE_EMAIL || 'prakharchauhan179@gmail.com';

    try {
      // Using Formspree (Free - set VITE_FORMSPREE_ID in .env)
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: import.meta.env.VITE_GITHUB_URL || 'https://github.com/Prakhar54-byte',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: import.meta.env.VITE_LINKEDIN_URL || 'https://linkedin.com/in/prakhar-chauhan-9a32b52b4',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: `mailto:${import.meta.env.VITE_EMAIL || 'prakharchauhan179@gmail.com'}`,
      icon: (
    ...
    {
      name: 'Codeforces',
      url: import.meta.env.VITE_CODEFORCES_URL || 'https://codeforces.com/profile/Prakhar54',
      icon: (
    ...
    {
      name: 'LeetCode',
      url: import.meta.env.VITE_LEETCODE_URL || 'https://leetcode.com/u/Prakhar54/',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="terminal-window p-6">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {error && (
                    <div className="bg-red-500/20 border border-red-400 text-red-400 px-4 py-2 rounded text-sm">
                      {error}
                    </div>
                  )}
                  <div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 bg-green-500/20 border border-green-400 text-green-400 rounded hover:bg-green-400 hover:text-black transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
