      ...
      <div className="min-h-screen bg-[#0a0e14] text-white flex flex-col items-center justify-center scanlines grid-bg">
        ...
        >
          ...
          <button
            ...
            className="mt-6 text-gray-500 text-sm hover:text-gray-300 font-mono w-full text-center"
          >
            ← Return to Base
          </button>
        </motion.div>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex justify-between items-center border-b border-[#30363d] pb-6">
          ...
          <div className="flex gap-4">
            <button
              onClick={fetchStats}
              className="px-4 py-2 bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded hover:bg-blue-500/20 transition-colors"
            >
              Refresh Data
            </button>
            <button
              onClick={() => (window.location.href = "/")}
              className="px-4 py-2 bg-red-500/10 text-red-400 border border-red-500/30 rounded hover:bg-red-500/20 transition-colors"
            >
              Exit
            </button>
          </div>
        ...
        {loading ? (
          <div className="text-center py-20 animate-pulse text-green-400">
            Loading Databanks...
          </div>
        ) : stats ? (
          <motion.div
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-[#0a0e14] text-gray-500 text-sm">
                      <th className="p-4 border-b border-[#30363d]">
                        TIMESTAMP
                      </th>
                      <th className="p-4 border-b border-[#30363d]">
                        IP ADDRESS
